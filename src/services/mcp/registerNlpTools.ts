...
export function registerNlpTools(
  ...
  server.registerTool({
    ...
    handler: (args) =>
      executeT2P(parseT2PArgs(args), llmConfig, servicesConfig),
  });
  ...
  server.registerTool({
    ...
    handler: (args) =>
      executeP2T(parseP2TArgs(args), llmConfig, servicesConfig),
  });
  ...
  server.registerTool({
    ...
    handler: (args) => executeAnalysis(parseAnalysisArgs(args), context),
  });
}
