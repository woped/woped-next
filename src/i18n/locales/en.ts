...
export default {
  ...
  chat: {
    ...
    stop: 'Stop',
    settings: 'Settings',
    setupRequired: 'Enter your OpenAI API key to use the chat assistant.',
    ...
    apiKey: {
      ...
      description: 'To use the chat assistant, enter your OpenAI API key.',
      label: 'API Key',
      model: 'Model',
      privacy: 'The key is only stored locally in your browser and sent directly to OpenAI — never to our servers.',
