...
export default {
  ...
  templates: {
    ...
    unboundedNetDesc:
      "Producer outpaces consumer — place grows without limit (shows ω in coverability graph)",
    pipeline: "Pipeline",
    ...
    orderFulfillmentDesc:
      "End-to-end order processing with parallel preparation",
  ...
  analysis: {
    ...
    coverabilityHint:
      "Explores all reachable markings. Uses ω (omega) for unbounded places to guarantee termination.",
    reachabilityHint:
      "Enumerates all exact reachable markings. Only works for bounded nets with a finite state space.",
    reachabilityOverflow:
      "The net appears unbounded — the state space exceeds the limit. Showing the coverability graph instead.",
    graphEmpty:
      'Click "Build Graph" to generate the graph from the current net.',
  ...
  properties: {
    ...
    manualHint:
      "Double-click arc to add waypoints, double-click handle to remove",
  ...
  chat: {
    ...
    settings: "Settings",
    setupRequired:
      "Enter your OpenAI or Gemini API key to use the chat assistant.",
    ...
    apiKey: {
      ...
      description:
        "To use the chat assistant, select a provider and enter your API key.",
      provider: "Provider",
      label: "API Key",
      model: "Model",
      privacy:
        "The key is only stored locally in your browser and sent directly to the selected provider (OpenAI or Google Gemini) — never to our servers.",
      ...
      modelUnavailable:
        "The selected model is not available with your API key. Please choose another model.",
      modelsLoadFailed:
