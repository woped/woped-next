...
export default {
  ...
  chat: {
    ...
    changesPartiallyFailed: 'Some changes could not be applied',
    commandErrors: {
      emptyPnml: 'No PNML content found in the response',
      importFailed: 'Could not import the generated net',
      missingPnml: 'Missing PNML data for import',
      addArcFailed: 'Could not add arc (invalid or unknown endpoints)',
      addArcInvalidType: 'Could not add arc (must connect place ↔ transition, not same type)',
      removeElementFailed: 'Could not find the element to remove',
      renameElementFailed: 'Could not rename the element',
      setTokensFailed: 'Could not set tokens on the place',
      skippedForImport: 'Skipped (net import replaces the model)',
      duplicateImportSkipped: 'Skipped (duplicate import)',
    },
    suggestions: {
