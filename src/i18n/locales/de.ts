...
export default {
  ...
  chat: {
    ...
    changesPartiallyFailed: 'Einige Änderungen konnten nicht angewendet werden',
    commandErrors: {
      emptyPnml: 'Kein PNML-Inhalt in der Antwort gefunden',
      importFailed: 'Das generierte Netz konnte nicht importiert werden',
      missingPnml: 'Keine PNML-Daten für den Import vorhanden',
      addArcFailed: 'Kante konnte nicht hinzugefügt werden (ungültige Endpunkte)',
      addArcInvalidType: 'Kante konnte nicht hinzugefügt werden (Stelle und Transition müssen abwechseln)',
      removeElementFailed: 'Element zum Entfernen nicht gefunden',
      renameElementFailed: 'Element konnte nicht umbenannt werden',
      setTokensFailed: 'Token konnten nicht gesetzt werden',
      skippedForImport: 'Übersprungen (Netzimport ersetzt das Modell)',
      duplicateImportSkipped: 'Übersprungen (doppelter Import)',
    },
    suggestions: {
