...
export default {
  ...
  templates: {
    ...
    parallelismDesc:
      "Nebenläufige Ausführung mit Verzweigung und Synchronisation",
    loop: "Schleife (Iteration)",
    loopDesc: "Zyklisches Verhalten mit Wiederholung",
    weightedArcs: "Gewichtete Kanten",
    weightedArcsDesc:
      "Multi-Token-Verbrauch und -Erzeugung mit Kantengewichten",
    ...
    unboundedNetDesc:
      "Erzeuger schneller als Verbraucher — Stelle wächst unbegrenzt (zeigt ω im Überdeckbarkeitsgraph)",
    pipeline: "Pipeline",
    ...
    orderFulfillmentDesc:
      "Durchgängige Bestellverarbeitung mit paralleler Vorbereitung",
    approvalProcess: "Genehmigungsprozess",
    approvalProcessDesc:
      "Prüf-Workflow mit Ablehnung und Überarbeitungsschleife",
    errorHandling: "Fehlerbehandlung",
    errorHandlingDesc:
      "Normalablauf mit Fehlererkennung, Wiederholung und Eskalation",
    stateMachine: "Ampel",
  ...
  tokenGame: {
    ...
    deadlock: "Deadlock!",
    deadlockMessage:
      "Keine Transitionen aktiviert - das Netz ist in einem Deadlock-Zustand.",
    history: "Verlauf",
  ...
  analysis: {
    ...
    coverabilityHint:
      "Erkundet alle erreichbaren Markierungen. Nutzt ω (Omega) für unbeschränkte Stellen, um Terminierung zu garantieren.",
    reachabilityHint:
      "Zählt alle exakt erreichbaren Markierungen auf. Funktioniert nur für beschränkte Netze mit endlichem Zustandsraum.",
    reachabilityOverflow:
      "Das Netz scheint unbeschränkt zu sein — der Zustandsraum überschreitet das Limit. Stattdessen wird der Überdeckungsgraph angezeigt.",
    graphEmpty:
      'Klicke auf "Graph erstellen", um den Graphen aus dem aktuellen Netz zu generieren.',
  ...
  settings: {
    ...
    t2pService: "Text → Petri-Netz (T2P)",
    t2pEndpoint: "T2P-Endpunkt-URL",
    t2pEnabled: "T2P aktivieren",
    p2tService: "Petri-Netz → Text (P2T)",
    p2tEndpoint: "P2T-Endpunkt-URL",
    p2tEnabled: "P2T aktivieren",
  ...
  properties: {
    ...
    manualHint:
      "Doppelklick auf Kante: Wegpunkt hinzufügen, Doppelklick auf Punkt: entfernen",
  ...
  simulation: {
    ...
    defaultTimeHint:
      "Wird für Transitionen ohne spezifische Zeitkonfiguration verwendet",
  ...
  messages: {
    unsavedChanges:
      "Sie haben ungespeicherte Änderungen. Möchten Sie vor dem Schließen speichern?",
  ...
  chat: {
    ...
    settings: "Einstellungen",
    setupRequired:
      "Geben Sie Ihren OpenAI- oder Gemini-API-Schlüssel ein, um den Chat-Assistenten zu nutzen.",
    ...
    apiKey: {
      ...
      description:
        "Um den Chat-Assistenten zu nutzen, wählen Sie einen Anbieter und geben Sie Ihren API-Schlüssel ein.",
      provider: "Anbieter",
      label: "API-Schlüssel",
      model: "Modell",
      privacy:
        "Der Schlüssel wird nur lokal in Ihrem Browser gespeichert und direkt an den gewählten Anbieter (OpenAI oder Google Gemini) gesendet — niemals an unsere Server.",
      required: "Bitte geben Sie einen API-Schlüssel ein.",
      invalid:
        "Der API-Schlüssel ist ungültig. Bitte prüfen und erneut versuchen.",
      validationFailed:
        "Schlüssel konnte nicht validiert werden. Prüfen Sie Ihre Verbindung.",
      validating: "Validiere...",
      refreshModels: "Modelle aktualisieren",
      loadingModels: "Modelle werden geladen...",
      checkingModels:
        "Es wird geprüft, welche Modelle mit Ihrem API-Schlüssel verfügbar sind...",
      enterKeyForModels:
        "API-Schlüssel eingeben, um verfügbare Modelle zu laden.",
      noModels: "Keine Modelle für diesen API-Schlüssel verfügbar.",
      modelRequired: "Bitte wählen Sie ein Modell aus.",
      modelUnavailable:
        "Das gewählte Modell ist mit Ihrem API-Schlüssel nicht verfügbar. Bitte ein anderes Modell wählen.",
      modelsLoadFailed:
