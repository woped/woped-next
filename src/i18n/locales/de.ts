...
export default {
  ...
  chat: {
    ...
    stop: 'Stopp',
    settings: 'Einstellungen',
    setupRequired: 'Geben Sie Ihren OpenAI API-Schlüssel ein, um den Chat-Assistenten zu nutzen.',
    ...
    apiKey: {
      title: 'OpenAI API-Schlüssel einrichten',
      description: 'Um den Chat-Assistenten zu nutzen, geben Sie Ihren OpenAI API-Schlüssel ein.',
      label: 'API-Schlüssel',
      model: 'Modell',
      privacy: 'Der Schlüssel wird nur lokal in Ihrem Browser gespeichert und direkt an OpenAI gesendet — niemals an unsere Server.',
